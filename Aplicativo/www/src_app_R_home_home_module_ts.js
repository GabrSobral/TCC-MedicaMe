...
let HomePage = class HomePage {
    ...
    enviar(nome, codigo, situacao) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.servidor.enviar('Home/situacao.php', dados).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
                if (res[0].Erro == 'Notificar') {
                    console.log('Banana');
                    yield _capacitor_local_notifications__WEBPACK_IMPORTED_MODULE_4__.LocalNotifications.removeAllListeners();
                    yield _capacitor_local_notifications__WEBPACK_IMPORTED_MODULE_4__.LocalNotifications.schedule({
                        notifications: [{
                                id: 1,
